...
//   return (
//     <div className="bg-black min-h-screen text-white font-sans px-4 py-10">
...
//                   className="bg-[#1a1a1a] p-3 rounded w-full border border-gray-700 text-white"
//                 />
//                 <input
//                   type="email"
//                   placeholder="Email"
...
//               <button
//                 type="submit"
//                 className="bg-orange-500 hover:bg-orange-600 px-6 py-2 rounded font-semibold"
//               >
//                 Lets Talk →
//               </button>
//             </form>
...
//           <h3 className="text-xl md:text-2xl font-semibold mb-9">
//             WANT TO WORK WITH US?
//           </h3>
//           <div className="flex flex-col md:flex-row justify-center items-center gap-6">
//             <img src={videoImage} alt="Camera Icon" className="w-40 h-40" />
//             <div className="max-w-xl text-lg text-left">
//               <p>
//                 Are you a{" "}
...
//                 </span>
//                 , or{" "}
//                 <span className="text-orange-400 font-semibold">CREATIVE SOUL</span>{" "}
...
//             WE’RE ALWAYS LOOKING FOR PASSIONATE COLLABORATORS AND FREELANCERS
//           </h2>
//           <div className="flex flex-col md:flex-row justify-center gap-6 mt-6">
//             <div className="bg-[#1a1a1a] rounded-lg p-6 w-full md:w-1/2">
//               <p className="text-sm text-gray-300 mb-2">Email Address</p>
//               <p className="text-white font-bold mb-3">example@exaple.com</p>
//               <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-md text-sm font-semibold">
//                 UnnFuredin
//               </button>
//             </div>
//             <div className="bg-[#1a1a1a] rounded-lg p-6 w-full md:w-1/2">
//               <p className="text-sm text-gray-300 mb-2">LinkedIn</p>
//               <p className="text-white font-bold mb-3">
//                 linkedin.com/in/ezexemple
//               </p>
//               <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-md text-sm font-semibold">
//                 Contact
//               </button>
...
const ContactPage: React.FC = () => {
  return (
    <div className="bg-black text-white font-sans px-4 py-10">
...
<div className="text-center my-20">
  ...
  <div className="flex flex-col md:flex-row justify-center items-center gap-10">
    ...
    />
    <div className="max-w-xl text-left md:text-right" style={{ fontSize: "33px" }}>
      <p>
        Are you a{" "}
        <span className="text-orange-400 font-semibold">
          FILMMAKER, EDITOR, DIRECTOR OF PHOTOGRAPHY, STYLIST, PRODUCTION DESIGNER
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mt-6">
            <div className="bg-[#1a1a1a] rounded-lg p-6 w-full md:w-1/2 text-left">
              <div className="flex items-center gap-3 mb-2">
                <img src={emailIcon} alt="Email" className="w-5 h-5" />
                <p className="text-sm text-gray-300">Email Address</p>
              </div>
              <p className="text-white font-bold mb-3">content@amplifyfilms.com</p>
              <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-md text-sm font-semibold">
                Send Email →
              </button>
            </div>
            <div className="bg-[#1a1a1a] rounded-lg p-6 w-full md:w-1/2 text-left">
              ...
              <p className="text-white font-bold mb-3">Connect with team directly</p>
              <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-md text-sm font-semibold">
                Send Email →
              </button>
            </div>
